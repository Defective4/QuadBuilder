...
public final class NBTEditor {
    ...
    public enum MinecraftVersion {
        v1_8, v1_9, v1_10, v1_11, v1_12, v1_13, v1_14, v1_15, v1_16, v1_17, v1_18_R1, v1_18_R2, v1_19, v1_20, v1_21,
        v1_22;
    ...
    public static String getTexture(ItemStack head) {
        ...
        try {
            ...
            Collection<Object> properties = (Collection<Object>) getMethod("values").invoke(
     ...
     * @param keys The keys to fetch; an integer after a key value indicates that it should get the nth place of the
     *             previous compound because it is a list;
    ...
    /**
     * Gets an NBT tag in a given block with the specified keys. Use {@link #getNBTCompound(Object, Object...)}
     * instead.
     *
    ...
    private static void setTag(Object tag, Object value, Object... keys)
        ...
        if (keys.length > 0) {
            ...
            if (wrappedValue != null) {
                ...
                if (getNMSClass("NBTTagCompound").isInstance(wrappedValue) && getNMSClass("NBTTagCompound").isInstance(
                        compound))
